...
import pandas as pd
import math
from tes import selecionar_e_converter
...
class Aplicativo:
    def __init__(self, master = None):
        ...
        #botão - .docx -> .xlsx
        #self.btnConverte = tk.Button(self.terceiroContainer, text='Converte', width='25', command=selecionar_e_converter)
        #self.btnConverte.pack()
